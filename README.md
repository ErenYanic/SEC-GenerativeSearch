...
**Backend:** 2608 tests, of which 915 are security-regression locks (`@pytest.mark.security`). **Frontend:** 288 tests across security and functional trees. A security-tree failure is a release blocker.
