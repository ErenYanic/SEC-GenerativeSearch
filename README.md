...
**Backend:** 2,344 tests, of which 790 are security-regression locks (`@pytest.mark.security`). **Frontend:** 279 tests across security and functional trees. A security-tree failure is a release blocker.
